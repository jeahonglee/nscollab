...
export default function ProfileForm({ user, profile }: ProfileFormProps) {
  ...
  return (
    <>
      ...
      />
      <LoadingOverlay
        isLoading={isAddingNsStay}
        loadingText="Adding NS stay..."
      />
      <LoadingOverlay
        isLoading={isDeletingNsStay}
        loadingText="Removing NS stay..."
      />
      <form
        onSubmit={async (e) => {
          e.preventDefault();
      ...
      >
              ...
              <div className="flex items-center gap-4 mb-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground mb-2">
                    Your profile picture will be automatically synced from your
                    auth provider.
                  </p>
                </div>
              </div>
            ...
            <div className="space-y-6">
              ...
              <div className="grid gap-2">
                <div className="flex items-center gap-2">
                  <Label htmlFor="discordUsername" className="min-w-28">
                    Discord
                  </Label>
                  <Input
                    id="discordUsername"
                ...
                <p className="text-sm text-muted-foreground">
                  Discord username is automatically set during Discord sign-in
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="flex items-center gap-2">
                  <Label htmlFor="githubUsername" className="min-w-28">
                    GitHub
                  </Label>
                  <Input
                    id="githubUsername"
                ...
                <div className="flex items-center gap-2">
                  <Label htmlFor="xHandle" className="min-w-28">
                    X (Twitter)
                  </Label>
                  <Input
                    id="xHandle"
                ...
                <div className="flex items-center gap-2">
                  <Label htmlFor="linkedinUrl" className="min-w-28">
                    LinkedIn
                  </Label>
                  <Input
                    id="linkedinUrl"
                ...
                <div className="flex items-center gap-2">
                  <Label htmlFor="instagramHandle" className="min-w-28">
                    Instagram
                  </Label>
                  <Input
                    id="instagramHandle"
                ...
                <div className="flex items-center gap-2">
                  <Label htmlFor="threadsHandle" className="min-w-28">
                    Threads
                  </Label>
                  <Input
                    id="threadsHandle"
                ...
                <div className="flex items-center gap-2">
                  <Label htmlFor="youtubeUrl" className="min-w-28">
                    YouTube
                  </Label>
                  <Input
                    id="youtubeUrl"
        ...
        <div className="border-b pb-8">
          ...
          <div className="grid gap-6">
            <div className="grid gap-2">
              ...
              <p className="text-sm text-muted-foreground mb-2">
                Enter your skills separated by commas (e.g., &quot;React,
                Python, Marketing, UI/UX&quot;)
              </p>
              <Textarea
                id="skills"
                name="skills"
            ...
            <div className="grid gap-2">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3 mt-2">
                {STATUS_TAGS.map((tag) => {
                  ...
                  const statusTags = Array.isArray(profile.status_tags)
                    ? profile.status_tags
                    : [];
                  const isChecked = statusTags.some(
                    (statusTag) =>
                      statusTag && statusTag.toLowerCase() === tag.toLowerCase()
                  );
        ...
        <div>
          ...
          <Card className="mb-6">
            ...
            <CardContent>
              ...
              <p className="text-sm text-muted-foreground mt-4">
                Click a month to toggle your participation. Selected months are
                highlighted.
              </p>
            </CardContent>
          </Card>
          ...
          <div className="hidden">
            {profile.ns_stays &&
              profile.ns_stays.map((stay) => (
                <input
                  key={stay.id}
                  type="hidden"
                  name={`ns_stay_${stay.id}`}
                  value={stay.id}
                />
              ))}
          </div>
